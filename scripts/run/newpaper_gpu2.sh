#!/bin/bash
# newpaper_gpu2.sh — 새 논문용 실험 (GPU 2)
# depth 200 missing runs (20 runs, 느린 depth)
set -e
...
echo "=== NewPaper GPU2 Start: $(date) | GPU: $GPU_ID ===" | tee -a $BATCH_LOG
...
echo "=== NewPaper GPU2 Complete: $(date) ===" | tee -a $BATCH_LOG
