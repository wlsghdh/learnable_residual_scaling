#!/bin/bash
# loop_master_gpu1.sh — GPU 1 자동 반복 실행
# =============================================
# master_run_gpu1.sh를 반복 실행:
#   1. master 실행 (최대 47시간)
...
#
# 실행:
#   nohup bash loop_master_gpu1.sh > logs/loop_master_gpu1.log 2>&1 &
#   echo $! > logs/loop_master_gpu1.pid
