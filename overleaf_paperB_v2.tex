...
\textbf{Scale of ImageNet evaluation.} Our ImageNet experiments are limited to ResNet-50 (16 blocks). Deeper ImageNet models would more strongly validate the depth--$\alpha$ scaling law at scale. We partially mitigate this by showing the law holds across four CIFAR depths (50--200) and that ImageNet ResNet-50 $\alpha$ values are consistent with CIFAR at the same depth, but extending to ResNet-101/152 on ImageNet is the most natural next step.
